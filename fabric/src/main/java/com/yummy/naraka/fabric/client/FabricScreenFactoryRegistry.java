...
public final class FabricScreenFactoryRegistry implements ScreenFactoryRegistry.Registrar {
    @Override
    public <M extends AbstractContainerMenu, S extends AbstractContainerScreen<M>> void register(Supplier<MenuType<M>> menu, MenuScreens.ScreenConstructor<M, S> constructor) {
