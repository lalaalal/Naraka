    ...
    public void generateAdvancement(HolderLookup.Provider registries, Consumer<AdvancementHolder> generator) {
        ...
        AdvancementHolder killOriginHerobrine = challenge(killHerobrine, NarakaItems.STIGMA_ROD.get(), AdvancementNarakaComponents.KILL_ORIGIN_HEROBRINE,
                builder -> builder.addCriterion(
                        ...
                        KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(entities, NarakaEntityTypes.ORIGIN_HEROBRINE.get()))
                )
        );
        ...
        AdvancementHolder ultimateSpear = challenge(soulSwords, NarakaItems.SPEAR_OF_LONGINUS_ITEM.get(), AdvancementNarakaComponents.ULTIMATE_SPEAR,
                builder -> builder.addCriterion(
                        "has_ultimate_spear",
