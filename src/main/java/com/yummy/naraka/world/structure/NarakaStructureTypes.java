...
public class NarakaStructureTypes {
    ...
    public static final DeferredHolder<StructureType<?>, StructureType<HerobrineSanctuaryStructure>> HEROBRINE_SANCTUARY = STRUCTURES.register(
            "herobrine_sanctuary",
            () -> () -> HerobrineSanctuaryStructure.CODEC
    );

    public static final DeferredHolder<StructurePieceType, StructurePieceType> HEROBRINE_SANCTUARY_PIECE = STRUCTURE_PIECES.register(
            "herobrine_sanctuary_piece",
            () -> HerobrineSanctuaryPiece::new
    );
