...
public class BlockTransparentRenderer implements IdentifiableResourceReloadListener, ResourceManagerReloadListener {
    ...
    public ResourceLocation getFabricId() {
        return NarakaMod.location("renderer", "block_transparent_renderer");
    }
