...
public class StarShootingSkill extends ComboSkill<Herobrine> {
    public static final ResourceLocation LOCATION = createLocation("final_herobrine.star_shooting");
    ...
    public StarShootingSkill(Herobrine mob, Skill<?> nextSkill) {
        super(LOCATION, mob, 80, 600, 0.5f, 75, nextSkill);
    }
    ...
    private void hurtOnSpinning(ServerLevel level) {
        if (mob.getCurrentAnimation().equals(HerobrineAnimationLocations.STAR_SHOOTING_2)) {
