...
public class SpinUpSkill extends ComboSkill<Herobrine> {
    ...
    protected void tickWithTarget(ServerLevel level, LivingEntity target) {
        ...
        runBetween(20, 25, () -> NarakaSkillUtils.sendTraceParticles(level, mob, NarakaFlameParticleOption.DIAMOND));
        ...
        run(between(20, 25), () -> hurtEntities(level, this::checkTarget, 3));
    ...
    private void blowBlocks(ServerLevel level, double distance, int startTick) {
        ...
        if (blowTick < 12) {
            ...
            level.playSound(mob, mob.blockPosition(), SoundEvents.BLAZE_SHOOT, SoundSource.HOSTILE, 1, 1);
        }
    }
