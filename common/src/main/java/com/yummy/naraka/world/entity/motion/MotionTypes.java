...
public class MotionTypes {
    ...
    public static final Identifier SWORD_SWING = register(NarakaMod.identifier("sword_swing"), Motion.builder()
            ...
            .channel(MotionChannel.translation(true)
                    .keyframe(MotionKeyframe.position(0))
                    .keyframe(MotionKeyframe.position(35, 1, -2.3, 0)
                            .interpolation(Interpolation.V_FAST_STEP_OUT)
                    )
                    .keyframe(MotionKeyframe.position(40, 2, -3, 1.5))
                    .keyframe(MotionKeyframe.position(44, 3.5, -3.8, 0))
                    .keyframe(MotionKeyframe.position(48, 1, -4, -1))
                    .keyframe(MotionKeyframe.position(55, 1.5, -5.2, 0.3))
                    .keyframe(MotionKeyframe.position(80, 2.3, -5.2, 0.7))
                    .keyframe(MotionKeyframe.position(85, 1.5, -4, 0.6))
                    .keyframe(MotionKeyframe.position(100, 1.1, -2, 0.2)
                            .interpolation(Interpolation.V_FAST_STEP_IN)
                    )
            )
    );

    public static final Identifier SWORD_STRIKE = register(NarakaMod.identifier("sword_strike"), Motion.builder()
            .channel(MotionChannel.rotation(true)
                    .keyframe(MotionKeyframe.rotation(0))
                    .keyframe(MotionKeyframe.rotation(40)
            ...
            .channel(MotionChannel.translation(true)
                    .keyframe(MotionKeyframe.position(0))
                    .keyframe(MotionKeyframe.position(40, 2.2, -5, 0.3)
                            .interpolation(Interpolation.V_FAST_STEP_OUT))
                    .keyframe(MotionKeyframe.position(82, 2.5, -5.1, 0.3))
                    .keyframe(MotionKeyframe.position(90, 0.3, -2, 0.1)
                            .interpolation(Interpolation.V_FAST_STEP_IN)
                    )
            )
    );
