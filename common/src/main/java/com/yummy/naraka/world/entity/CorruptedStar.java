...
public class CorruptedStar extends LightTailEntity implements StigmatizingEntity {
    ...
    @Override
    public boolean deflect(ProjectileDeflection deflection, @org.jetbrains.annotations.Nullable Entity entity, @org.jetbrains.annotations.Nullable Entity owner, boolean deflectedByPlayer) {
        return false;
    }
