...
public final class EntityDataType<T, E extends Entity> {
    ...
    private EntityDataType(Identifier id, Codec<T> codec, StreamCodec<? super RegistryFriendlyByteBuf, T> streamCodec, boolean synchronize, Class<E> entityType, Function<EntityDataType<T, E>, EntityData<T, E>> defaultInstance, ClientTicker<T, E> clientTicker, ServerTicker<T, E> serverTicker) {
        this.id = id;
