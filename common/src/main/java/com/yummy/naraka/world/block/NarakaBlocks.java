...
public class NarakaBlocks {
    ...
    public static final HolderProxy<Block, Block> SOUL_INFUSED_COPPER_BLOCK = registerSoulInfusedBlock("copper_block", Blocks.COPPER_BLOCK.weathering().unaffected());
    ...
    public static final HolderProxy<Block, HerobrineTotem> HEROBRINE_TOTEM = registerBlockWithItem(
            ...
            item().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, new ItemLore(
                            List.of(Component.translatable(LanguageKey.tooltip("herobrine_totem")))
                    ))
    );
