...
public class NarakaItems {
    ...
    public static final HolderProxy<Item, Item> HEROBRINE_SPAWN_EGG = registerItem(NarakaItemIds.HEROBRINE_SPAWN_EGG, properties -> new SpawnEggItem(NarakaEntityTypes.HEROBRINE.get(), 0, 0xff0000, properties));
    public static final HolderProxy<Item, Item> DIAMOND_GOLEM_SPAWN_EGG = registerItem(NarakaItemIds.DIAMOND_GOLEM_SPAWN_EGG, properties -> new SpawnEggItem(NarakaEntityTypes.DIAMOND_GOLEM.get(), 0, SoulType.DIAMOND.color, properties));

    public static HolderProxy<Item, Item> registerPurifiedSoulArmorItem(ResourceKey<Item> key, Holder<ArmorMaterial> armorMaterial, ArmorItem.Type armorType) {
