...
public class NarakaItemTooltip {
    ...
    public static final NarakaItemTooltip SOUL_INFUSED_MATERIALS = simple(NarakaMod.location("soul_infused_materials"), 1, 1);
    ...
    private static NarakaItemTooltip simple(ResourceLocation id, int purpose, int detail) {
    ...
    public NarakaItemTooltip(ResourceLocation id) {
        this.id = id;
    }
