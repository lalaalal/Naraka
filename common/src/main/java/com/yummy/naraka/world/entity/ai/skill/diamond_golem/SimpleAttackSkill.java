...
public class SimpleAttackSkill extends AttackSkill<SkillUsingMob> {
    ...
    protected SimpleAttackSkill(Identifier location, SkillUsingMob mob, int duration, int cooldown, int attackTick, Vec3 attackRange, int usdDistance, SoundEvent sound) {
