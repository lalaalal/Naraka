...
public class HerobrineComboAttackAnimation {
    public static void initialize() {
        ...
        AnimationMapper.register(HerobrineAnimationIdentifiers.COMBO_ATTACK_2, COMBO_ATTACK_2);
        AnimationMapper.register(HerobrineAnimationIdentifiers.COMBO_ATTACK_3, COMBO_ATTACK_3);
        AnimationMapper.register(HerobrineAnimationIdentifiers.COMBO_ATTACK_4, COMBO_ATTACK_4);
        AnimationMapper.register(HerobrineAnimationIdentifiers.COMBO_ATTACK_5, COMBO_ATTACK_5);
    }
