...
public final class NarakaClientServices {
    public static final PacketRegistrar.Client CLIENT_PACKET_REGISTRAR = load(PacketRegistrar.Client.class);
    public static final ServerboundNetworkManager SERVERBOUND_NETWORK_MANAGER = load(ServerboundNetworkManager.class);
