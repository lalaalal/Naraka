...
public class FinalHerobrineSkillAnimation {
    public static void initialize() {
        ...
        AnimationMapper.register(HerobrineAnimationLocations.STAR_SHOOTING_1, STAR_SHOOTING_1);
        AnimationMapper.register(HerobrineAnimationLocations.STAR_SHOOTING_2, STAR_SHOOTING_2);
        AnimationMapper.register(HerobrineAnimationLocations.STAR_SHOOTING_3, STAR_SHOOTING_3);
        AnimationMapper.register(HerobrineAnimationLocations.RYOIKI_TENKAI, PICKAXE_STRIKE);
    }
