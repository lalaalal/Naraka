...
public class DeathCountHud implements HudRenderer {
    ...
    private static void drawHeart(GuiGraphics guiGraphics, int x, int y, boolean fill, boolean blink) {
        if (fill) {
            ...
            guiGraphics.blit(NarakaSprites.DEATH_COUNT_HEART, HEART_WIDTH, HEART_HEIGHT,
                    u, 0, x, y,
    ...
    public void render(GuiGraphics guiGraphics, float partialTicks) {
        ...
        guiGraphics.blit(NarakaSprites.DEATH_COUNT_BACKGROUND, BASE_X, BASE_Y, 0, 0, BACKGROUND_WIDTH, BACKGROUND_HEIGHT);
