...
public class NarakaBlockItemIds {
    ...
    private static BlockItemId create(String id) {
        ResourceKey<Item> itemKey = ResourceKey.create(Registries.ITEM, NarakaMod.identifier(id));
        ResourceKey<Block> blockKey = ResourceKey.create(Registries.BLOCK, NarakaMod.identifier(id));
