...
public class NarakaItemIds {
    ...
    public static final ResourceKey<Item> CORRUPTED_STAR_STAFF = create("corrupted_star_staff");
    ...
    public static ResourceKey<Item> create(String id) {
        return ResourceKey.create(Registries.ITEM, NarakaMod.identifier(id));
    }
}
